...
public class Patient extends DomainObject<Patient> implements Serializable {
    ...
    /**
     * Used for creating empty profiles for Patient
     *
     * @param user
     *            is the Patient user
     * @return returns a Patient with no demographics set
     */
    public static Patient getEmptyProfile ( final User user ) {
        final Patient toReturn = new Patient();
    ...
    /** Id for pharmacy of patient's choice */
    private Long         defaultPharmacyId;

    /**
     * Boolean that stores patient's brand preference. True is branded / False
     * is generic
     */
    private Boolean      brandPreference;
    ...
    public void setEmail ( final String email ) {
        if ( email == null || email.length() > 30 || !email.matches( "[\\w\\.@]+" ) ) {
    ...
    /**
     * Sets the preferences for the patient's default pharmacy and prescription
     * type
     *
     * @param ppf
     *            is the form
     */
    public void setPreferences ( final PatientPreferenceForm ppf ) {
        this.brandPreference = Boolean.valueOf( ppf.getBrandPreference() );
        this.defaultPharmacyId = ppf.getDefaultPharmacyId();
    }

    /** Clears the preferences for default pharmacy and prescription type */
    public void clearPreferences () {
        this.brandPreference = null;
        this.defaultPharmacyId = null;
    }

    /**
     * Returns the brand preference
     *
     * @return true for branded / false for generic
     */
    public boolean getBrandPreference () {
        return this.brandPreference.booleanValue();
    }

    /**
     * Returns the id for the default pharmacy
     *
     * @return a Long id
     */
