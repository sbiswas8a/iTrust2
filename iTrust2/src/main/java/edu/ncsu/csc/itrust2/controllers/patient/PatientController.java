...
public class PatientController {
    ...
    /**
     * Provides the page for a User to view and edit their default preferences
     *
     * @param model
     *            The data for the front end
     * @return The page to show the user so they can edit demographics
     */
    @GetMapping ( value = "patient/demographics/editDefaultPref" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String viewDefaultPrefs ( final Model model ) {
        final User self = User.getByName( LoggerUtil.currentUser() );
        LoggerUtil.log( TransactionType.VIEW_DEMOGRAPHICS, self );
        return "/patient/demographics/editDefaultPref";
    }
