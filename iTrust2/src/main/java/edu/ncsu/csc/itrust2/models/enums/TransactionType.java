...
public enum TransactionType {
    ...
    /**
     * Admin creates default demographics
     */
    CREATE_EMPTY_DEMOGRAPHICS ( 412, "Empty demographics profile created by admin", true ),
     ...
     * Pharmacy created
     */
    CREATE_PHARMACY ( 550, "New Pharmacy created", false ),
    /**
     * Pharmacy viewed by user
     */
    VIEW_PHARMACY ( 551, "Pharmacy viewed", false ),
    /**
     * Pharmacy modified by user
     */
    EDIT_PHARMACY ( 552, "Pharmacy edited", false ),
    /**
     * Pharmacy deleted
     */
    DELETE_PHARMACY ( 553, "Pharmacy deleted", false ),

    /**
     * Pharmacist assigned
     */
    PHARMACIST_ASSIGN ( 575, "Pharmacist assigned", false ),

    /**
     * Pharmacist unassigned
     */
    PHARMACIST_UNASSIGN ( 576, "Pharmacist unassigned", false ),
    ...
    /**
     * Pharmacist viewed their list of prescriptions
     */
    PHARMACIST_PRESCRIPTION_VIEW ( 915, "Pharmacist viewed the pharmacy's list of prescriptions", false ),

    /**
     * Prescription(s) sent to a pharmacy
     */
    PRESCRIPTION_SENT ( 916, "Prescription(s) from office visit sent to a pharmacy", true ),

    /**
     * Pharmacist filled a prescription
     */
    PRESCRIPTION_FILL ( 917, "Pharmacist filled a prescription", true ),

    /**
     * Patient notified about their prescription being filled
     */
    PRESCRIPTION_FILL_EMAIL ( 918, "Patient notified about filled prescription", true ),

    /**
     * Pharmacist notified patient their prescription could not be filled
     */
    PRESCRIPTION_NOT_FILL_EMAIL ( 919, "Pharmacist notified patient their prescription could not be filled", true ),

    /**
     * Patient picked up their prescription
     */
    PRESCRIPTION_PICKED_UP ( 920, "Patient picked up their prescription", true ),
    ...
    /**
     * Patient set their preferences for default pharmacy and prescription type
     */
    PATIENT_PREFERENCES_SET ( 1202, "Patient set their preferences", true ),

    /**
     * Patient cleared their preferences for default pharmacy and prescription
     * type
     */
    PATIENT_PREFERENCES_CLEAR ( 1203, "Patient cleared their preferences", true ),

    /**
     * Patient fetched their preferences for default pharmacy and prescription
     * type
     */
    PATIENT_PREFERENCES_FETCH ( 1204, "Patient fetched their preferences", true ),
