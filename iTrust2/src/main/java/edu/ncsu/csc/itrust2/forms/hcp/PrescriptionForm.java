...
public class PrescriptionForm implements Serializable {
    ...
    public PrescriptionForm ( final Prescription prescription ) {
        ...
        setBrandPreference( prescription.getBrandPreference() );
    }
    ...
    /**
     * Sets the brand preference as indicated by the patient
     *
     * @param branded
     *            is the boolean to set. True indicates branded / False
     *            indicates generic
     */
    ...
    /**
     * Returns the brand preference for the prescription
     *
     * @return returns a boolean. True is branded / false is generic
     */
