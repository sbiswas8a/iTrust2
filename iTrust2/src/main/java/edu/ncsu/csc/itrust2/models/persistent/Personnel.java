...
public class Personnel extends DomainObject<Personnel> {
    ...
    /**
     * Used for creating empty profiles for HCPs
     *
     * @param user
     *            is the HCP user
     * @return returns a Personnel with no demographics set
     */
    public static Personnel getEmptyProfile ( final User user ) {
        final Personnel toReturn = new Personnel();
        toReturn.setSelf( user );
        toReturn.setEnabled( user.getEnabled().intValue() == 1 );
        return toReturn;
    }
    ...
    /**
     * Get the personnel by role
     *
     * @param type
     *            the role to look for
     * @return the list of personnels with the given role
     */
    public static List<Personnel> getByRole ( final Role type ) {
        final List<Personnel> all = getPersonnel();
        final List<Personnel> toReturn = new ArrayList<Personnel>();
        for ( final Personnel p : all ) {
            if ( p.getSelf().getRole().equals( type ) ) {
                toReturn.add( p );
            }
        }
        return toReturn;
    ...
    /** The type of institution this personnel is assigned to */
    @OneToOne
    private InstitutionType institutionType;

    /**
     * The id of the institution the personnel works at
     */
    private String          institutionId;

    /**
     * The name of the institution the personnel works at. In case id and name
     * for institution are different
     */
    private String          institutionName;

    /**
     * Whether or not the personnel has been assigned to an institution
     */
    ...
    /**
     * Gets whether or not this personnel is assigned to an institution
     *
     * @return whether or not this personnel is assigned to an institution
     */
    ...
    /**
     * Gets the type of institution this personnel works at
     *
     * @return the type of institution this personnel works at
     */
    ...
    /**
     * Assigns this Personnel to an Institution
     *
     * @param type
     *            is the InstitutionType this Personnel is assigned to
     * @param institutionId
     *            is the id of the institution they are assigned to
     * @param institutionName
     *            is the name of the institution they are assigned to
     */
    public void assign ( final InstitutionType type, final String institutionId, final String institutionName ) {
    ...
    /**
     * Unassigns this Personnel from any institution
     *
     */
