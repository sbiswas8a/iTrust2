...
public class GeneralCheckup extends OfficeVisit {
    ...
    /**
     * Sets the pharmacy for sending the prescriptions from this office visit
     *
     * @param pharmacyId
     *            is the id of the Pharmacy to set
     */
    public void setPharmacy ( final Long pharmacyId ) {
        if ( pharmacyId == null ) {
            this.pharmacy = null;
            return;
        }
        this.pharmacy = Pharmacy.getById( pharmacyId );
    }

    /**
     * Returns the pharmacy where the prescriptions from this office visit were
     * sent
     *
     * @return returns a Pharmacy OR null if not set
     */
    ...
    /**
     * Pharmacy the prescriptions will be sent to
     */
    @OneToOne
    ...
    private Set<Prescription>            prescriptions = Collections.emptySet();
