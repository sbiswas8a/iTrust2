...
public class GeneralCheckupForm extends OfficeVisitForm implements Serializable {
    ...
    /** Prescription forms to create prescriptions from */
    private List<PrescriptionForm> prescriptions;

    /** Pharmacy preference indicated by Patient */
    @Nullable
    ...
    public GeneralCheckupForm ( final GeneralCheckup officeVisit ) {
        ...
        setPrescriptions( officeVisit.getPrescriptions().stream()
    ...
    /**
     * Sets the id for the preferred pharmacy
     *
     * @param id
     *            is the id to set
     */
    public void setPharmacyId ( final Long id ) {
        this.pharmacyId = id;
    }

    /**
     * Returns the id for the preferred pharmacy
     *
