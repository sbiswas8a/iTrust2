...
public class User extends DomainObject<User> implements Serializable {
    ...
    /**
     * True if the user is an HCP, OD, OPH, Virologist, or Pharmacist
     *
     * @return true if the user role matches HCP, OD, Virologist, OPH, or
     *         Pharmacist
     */
    public boolean isDoctor () {
        return ( role == Role.ROLE_HCP || role == Role.ROLE_OD || role == Role.ROLE_OPH || role == Role.ROLE_VIROLOGIST
