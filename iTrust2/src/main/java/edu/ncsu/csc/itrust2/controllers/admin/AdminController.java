...
public class AdminController {
    ...
    /**
     * Creates the form page for the Manage Pharmacies
     *
     * @param model
     *            Data for the front end
     * @return Page to show to the user
     */
    @RequestMapping ( value = "admin/pharmacies" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String managePharmacy ( final Model model ) {
        return "/admin/pharmacies";
    }

    /**
     * Creates the form page for the Manage Pharmacists
     *
     * @param model
     *            Data for the front end
     * @return Page to show to the user
     */
    @RequestMapping ( value = "admin/pharmacists" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String managePharmacists ( final Model model ) {
