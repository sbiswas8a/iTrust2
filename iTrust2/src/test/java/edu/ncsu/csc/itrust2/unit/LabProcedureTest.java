...
public class LabProcedureTest {
    ...
    private OfficeVisit makeOfficeVisit () {
        ...
        visit.setPrescriptions( Collections.singleton( pres ) );
    ...
    private ICDCode makeICD ( final String code, final String description ) {
    ...
    private void addResultEntry ( final LOINCForm form, final List<ResultEntry> resultEntries, final String min,
            final String max, final ICDCode icd ) {
