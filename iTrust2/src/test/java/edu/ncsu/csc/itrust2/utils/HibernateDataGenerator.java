...
public class HibernateDataGenerator {
    ...
    public static void generateUsers () {
        ...
        final User patient = new User( "patient", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.",
                Role.ROLE_PATIENT, 1 );
        patient.save();
        final Patient patientProfile = Patient.getEmptyProfile( patient );
        patientProfile.save();

        final User pharmacist = new User( "pharmacist", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.",
                Role.ROLE_PHARMACIST, 1 );
        pharmacist.save();
        final Personnel pharmacistProfile = Personnel.getEmptyProfile( pharmacist );
    ...
    public static void generateFindExpertTest () {
        ...
        ryan.setInstitutionId( "Rex Hospital" );
        ...
        neetya.setInstitutionId( "Rex Hospital" );
        ...
        eddie.setInstitutionId( "UNC Hospital" );
